/*1.	Una clínica de maternidad necesita un sistema para determinar cuántos bebés
han nacido recientemente. Dicho sistema solicita al usuario capturar la cantidad de nacimientos (N),
...
public class Clinica_bebes {
    ...
    public static void main(String[] args) {
        ...
        String genero, nombre; // genero F o M 
        int N,F=0,M=0,c =1;
